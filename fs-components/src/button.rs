// fs-components/button.rs — Button component with variants, sizes, and loading state.
            ...
            if props.loading {
                span {
                    style: "width: 12px; height: 12px; border-radius: 50%; \
                            ...
                            animation: fs-spin 0.6s linear infinite; display: inline-block;",
                    aria_hidden: "true",
                }
            }
...
pub fn IconButton(props: IconButtonProps) -> Element {
    ...
    let variant_class = format!("fs-icon-btn fs-icon-btn--{}", props.variant.class_suffix());
