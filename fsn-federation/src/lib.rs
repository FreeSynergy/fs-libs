// fsn-federation — OIDC discovery, SCIM provisioning, and ActivityPub federation
...
/// Error returned when building a [`activitypub::FsnFederationConfig`] fails.
///
...
#[cfg(feature = "activitypub")]
pub use activitypub::{
    ActorKind, FsnActor, FsnFederationConfig, ObjectId, PublicKeyInfo, WithContext,
