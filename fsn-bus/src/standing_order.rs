// fsn-bus/src/standing_order.rs — Standing orders: persistent trigger rules.
...
mod tests {
    ...
    fn trigger_for_role_matching() {
        ...
        let events = eng.trigger_for_role("chat", "fsn-bus");
    ...
    fn trigger_for_role_disabled() {
        ...
        assert!(eng.trigger_for_role("chat", "fsn-bus").is_empty());
    }
