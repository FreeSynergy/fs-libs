...
// These are called by the host runtime (fs-plugin-runtime) at the appropriate
...
///
/// ```rust,ignore
/// use fs_plugin_sdk::traits::{LifecycleEvent, PluginInstall};
/// use fs_plugin_sdk::{PluginResponse, ShellCommand};
///
...
///
/// ```rust,ignore
/// use fs_plugin_sdk::traits::{LifecycleEvent, PluginRemove};
/// use fs_plugin_sdk::{PluginResponse, ShellCommand};
///
/// struct ZentinelPlugin;
///
