...
/// Manages version history for installed packages (in-memory; persisted via fs-db).
///
/// The caller is responsible for persisting changes using [`fs_db::InstalledPackageRepo`].
