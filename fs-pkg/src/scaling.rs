...
///
/// ```rust
/// use fs_pkg::scaling::{ScalingManifest, ScalingDialog, WorkerMode};
///
...
/// assert!(roles.contains(&fs_pkg::scaling::InstanceRole::Worker));
/// assert!(roles.contains(&fs_pkg::scaling::InstanceRole::Standalone));
/// ```
