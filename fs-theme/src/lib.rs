// fs-theme — Theme system for FreeSynergy.
//
...
mod tests {
    ...
    #[test]
    fn from_css_accepts_fs_prefix_with_priority() {
        let css = ":root { --fs-primary: #aabbcc; --primary: #ff0000; }";
        let engine = ThemeEngine::from_css(css, "FsPrefixed").unwrap();
        // --fs-* takes priority over plain --*
