//! `fsn-inventory` — local inventory of installed FreeSynergy resources.
//!
...
//! # Database
//!
//! Uses its own SQLite file: `fsn-inventory.db`.
...
//! let inv = Inventory::open("fsn-inventory.db").await?;
