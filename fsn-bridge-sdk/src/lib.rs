...
//!
//! ```rust,ignore
//! use fsn_bridge_sdk::{BridgeConfig, HttpBridge, BridgeInfo, ProbableBridge};
...
//!
//!     fn probe(&self) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<BridgeInfo, FsnError>> + Send + '_>> {
//!         Box::pin(async move {
