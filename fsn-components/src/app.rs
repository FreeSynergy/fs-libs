// fsn-components/app.rs — AppLauncher, ThemeSwitcher, LangSwitcher.
            ...
            for theme in &props.themes {
                {
                    ...
                    let label_color = if is_active {
                        ...
                        "var(--fsn-color-text-muted, #64748b)"
                    };
