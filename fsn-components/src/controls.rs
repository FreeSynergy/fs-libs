// fsn-components/controls.rs — MultiSelect, Toggle, RadioGroup, Slider.
                        ...
                        label {
                            ...
                            input {
                                ...
                                style: "width: 14px; height: 14px; \
                                        accent-color: var(--fsn-color-primary, #06b6d4);",
                                onchange: move |_| {
    ...
    rsx! {
        div {
            ...
            input {
                ...
                value: "{props.value}",
                disabled: props.disabled,
                style: "width: 100%; accent-color: var(--fsn-color-primary, #06b6d4);",
                oninput: move |e| {
