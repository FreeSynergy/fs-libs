// fsn-components/overlay.rs — ContextMenu, NotificationList, HelpPanel.
    ...
    rsx! {
        div {
            ...
            style: "position: fixed; top: 0; right: 0; bottom: 0; z-index: 900; \
                    ...
                    background: var(--fsn-color-bg-sidebar, #0f172a); \
                    border-left: 1px solid var(--fsn-color-border-default, #334155); \
