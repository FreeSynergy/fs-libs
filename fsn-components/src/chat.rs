// fsn-components/chat.rs — LlmChat: chat message history + input box.
    ...
    rsx! {
        div {
            ...
            style: "display: flex; flex-direction: column; height: 100%; min-height: 300px; \
                    background: var(--fsn-color-bg-canvas, #161b22); \
                    border: 1px solid var(--fsn-color-border-default, #334155); \
                    border-radius: 10px; overflow: hidden;",

            // Message history
            div {
                class: "fsn-chat-messages",
                    ...
                    div {
                        ...
                        span {
                            style: "width: 6px; height: 6px; border-radius: 50%; \
                                    background: var(--fsn-color-text-muted, #64748b); \
                                    animation: fsn-bounce 1.2s ease-in-out infinite;",
                        }
                        span {
                            style: "width: 6px; height: 6px; border-radius: 50%; \
                                    background: var(--fsn-color-text-muted, #64748b); \
                                    animation: fsn-bounce 1.2s ease-in-out 0.2s infinite;",
                        }
                        span {
                            style: "width: 6px; height: 6px; border-radius: 50%; \
                                    background: var(--fsn-color-text-muted, #64748b); \
                                    animation: fsn-bounce 1.2s ease-in-out 0.4s infinite;",
                        }
                    }
                }
            }
