// snippets.rs — Built-in i18n snippets bundled with fsn-i18n.
//
...
///
/// ```rust
/// use fsn_i18n::{I18n, snippets::load_builtins};
///
...
/// ```
pub fn load_builtins(i18n: &mut I18n) -> Result<(), FsnError> {
...
///
/// ```rust
/// use fsn_i18n::snippets::builtin_i18n;
///
/// let i18n = builtin_i18n("en").unwrap();
/// assert_eq!(i18n.t("errors.not_found"), "Not found");
/// ```
pub fn builtin_i18n(active_lang: &str) -> Result<I18n, FsnError> {
