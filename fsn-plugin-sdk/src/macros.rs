...
///
/// Generates the WASM exports expected by the `fsn-plugin-runtime` host:
...
///
/// ```rust,ignore
/// use fsn_plugin_sdk::{plugin_main, PluginImpl, PluginManifest, PluginContext, PluginResponse};
///
/// #[derive(Default)]
/// struct MyPlugin;
///
